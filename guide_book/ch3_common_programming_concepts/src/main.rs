fn main() {
    ...
    */
    ...
    const _MAX_POINTS: u32 = 100_000; // must not insert mut, all capitals, underscores.
    ...
    */
    ...
    // addition
    let _sum = 5 + 10; // i32(default)
                       // subtraction
    let _difference = 95.5 - 4.3; // f64(default)
                                  // multiplication
    let _product = 4 * 30;
    // division
    ...
    let (_x, _y, _z) = tup; // destruction
    let _five_hundred = tup.0; // indexing
    ...
    */
    let _y = {
        // The right side also is an expression.
        let x = 3;
